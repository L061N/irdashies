    ...
    <tr>
      ...
      <td colSpan={4} className="p-0">
        <div className={`[text-shadow:_1px_1px_1px_rgba(0_0_0/0.2)] mt-3 flex`}>
          <span
            className={`${getTailwindStyle(classColor).classHeader} px-2 py-0.8 font-bold border-l-4`}
          >
            {className}
          </span>
          <span
            className={`${getTailwindStyle(classColor).driverIcon} px-2 py-0.8 flex items-center gap-1`}
          >
            {sof ? (
              <>
